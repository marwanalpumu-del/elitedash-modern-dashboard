...
import { LayoutGrid, FileText, ShoppingCart, Users, Settings, Globe, Sun, Moon, Menu, X, Bell, BarChart3, MessageSquare } from 'lucide-react';
// استيراد الصفحات
...
import Analytics from './pages/Analytics'; // الصفحة الجديدة
import ChatPage from './pages/ChatPage'; // الصفحة الجديدة
...
export default function App() {
  ...
  // القائمة المحدثة بـ 7 خيارات (لرفع السعر)
  const menu = [
  ...
  return (
    <div className={`min-h-screen flex transition-all duration-500 ${dark ? 'bg-[#030712] text-white' : 'bg-slate-50 text-slate-900'}`} dir={lang === 'ar' ? 'rtl' : 'ltr'}>
      
      {/* تأثير الإضاءة الخلفية (Glassmorphism BG) - إضافة احترافية */}
